...
using LiberacaoCredito.Devedor.API;
using LiberacaoCredito.Devedor.Core.Tests.Mocks;
using LiberacaoCredito.Devedor.Core.Tests.Mocks.Factory;
...
using System.Text;
using Moq.Dapper;
using LiberacaoCredito.Devedor.Core.Tests.Fixture;
using LiberacaoCredito.Devedor.Domain.Models;
//using LiberacaoCredito.Devedor.API.ViewModels.Customer;
using NJsonSchema;
using LiberacaoCredito.Devedor.Infra.Context;



namespace LiberacaoCredito.Devedor.Integration.Tests.API
{
